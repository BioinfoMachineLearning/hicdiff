...
class ResnetBlock(nn.Module):
    def __init__(self, dim = n_feat, dim_out = n_feat, *, time_emb_dim = n_feat * 4, use_affine_level=False): # dim == dim_out
        super().__init__()
...
class hicedrn_Diff(nn.Module):
    def __init__(self,
        ...
        if self.random_or_learned_sinusoidal_cond:
            ...
            sinu_pos_emb = PositionalEncoding(n_feat)
            fourier_dim = n_feat
        else:
