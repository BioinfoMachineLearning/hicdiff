...
class Denoise(object):
    ...
    def sample_sequence(self, model, cls_fn=None):  # this function is used in the above function 'sample()'
        ...
        H_funcs = MakeFunc(deg = deg, image_channel = config.data.channels, image_size = self.config.data.image_size, device = self.device)
        ...
        for x_orig, classes in pbar:
            ...
            # NOTE: This means that we are producing each predicted x_(t-1) at timestep t until t = 0.
            with torch.no_grad():
