...
class HiCDiff:
    def __init__(self, epoch = 1000, cell_Line = 'Human', cellNo = 1, res = 40000, batch_size = 64, piece_s = 64, timestep = 1000):
        ...
        wandb.run.name = f'Unet_Diff cell_{cellNo}'
    ...
    def fit_model(self):
        ...
        for epoch in range(1, self.epoch + 1):
            ...
            final_ckpt_g = f'finalg_{self.res}_c{self.chunk}_s{self.chunk}_{self.cell_Line}{self.cellNo}_unet.pytorch'
            ...
            with torch.no_grad():
                for _, data, info in valid_bar:  # data is pure image without noise
                    batch_size = data.shape[0]
                ...
                if valid_loss < best_loss:
                    ...
                    best_ckpt_file = f'bestg_{self.res}_c{self.chunk}_s{self.chunk}_{self.cell_Line}{self.cellNo}_unet.pytorch'
